...
const icons = {
    dashboard: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="3" width="7" height="7"/>
      <rect x="14" y="3" width="7" height="7"/>
      <rect x="14" y="14" width="7" height="7"/>
      <rect x="3" y="14" width="7" height="7"/>
    </svg>),
    sync: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/>
      <path d="M3 3v5h5"/>
      <path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"/>
      <path d="M16 16h5v5"/>
    </svg>),
    radar: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    arrow: (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 12h14"/>
    ...
    return (<section className={styles.hero}>
      <div className={styles.heroInner}>
        ...
        <div className={styles.heroButtons}>
          ...
          <Link to="https://testream.app" className={styles.secondaryButton}>
            Claim Free API Key
            {icons.arrow}
          </Link>
        </div>
        <div className={styles.heroReportersSection}>
          ...
          <div className={styles.heroReportersGrid}>
            {reporters.map((reporter) => (<HeroReporterCard key={reporter.name} reporter={reporter}/>))}
          </div>
        </div>
      </div>
    </section>);
...
const features = [
    {
        ...
        title: 'Instant Setup',
        description: 'npm install, run your tests, done. Testream captures results automatically with zero configuration.',
    },
    {
        icon: icons.radar,
        title: 'Comprehensive Test Management',
        description: 'Track test cases, analyze trends, spot flaky tests early. Create Jira tickets from failures and improve releases with actionable test insights.',
    },
    {
        icon: icons.sync,
        title: 'CI/CD Native',
        description: 'Works with GitHub Actions, GitLab, CircleCI, Jenkins, and more. One CLI for any pipeline.',
    },
];
    ...
    return (<section className={styles.features}>
      <div className={styles.featuresInner}>
        ...
        <div className={styles.featureGrid}>
          {features.map((feature, idx) => (<div key={idx} className={styles.featureCard}>
...
function HeroReporterCard({ reporter }) {
    ...
    return (<Link to={reporter.docsLink} className={styles.heroReporterCard}>
      <img src={reporter.icon} alt={reporter.name} className={styles.heroReporterIcon}/>
      ...
      <div className={styles.installCommandBox} onClick={handleCopy}>
        ...
        <button className={`${styles.copyIconButton} ${copied ? styles.copied : ''}`} aria-label="Copy install command" type="button">
...
export default function Home() {
    ...
    return (<Layout title={siteConfig.title} description="Official documentation for Testream test management platform">
      <main>
        <HeroSection />
        <FeaturesSection />
        <HowItWorksSection />
