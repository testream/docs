...
description: Link automated test runs to Jira releases so teams can review pass rate, quality gates, release readiness, and Jira release test management per version.
keywords:
