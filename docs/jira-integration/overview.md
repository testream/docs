...
- **Suite and release signal** - [Test Suite Changes](../features/test-suite-changes), [Trends & Analytics](../features/trends-analytics), and [Release Management](../features/release-management) show how quality changes across branches, runs, and releases.
