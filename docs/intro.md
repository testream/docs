...
Install the [Testream – Test Management & Quality Evidence for Jira app](https://marketplace.atlassian.com/3048460704) to make automated test evidence visible inside Jira:
